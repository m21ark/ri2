...
class MyAgentAttacker(Base_Agent):
    def __init__(self, host:str, agent_port:int, monitor_port:int, enable_log=False, enable_draw=False, unum = 2, wait_for_server=True, is_fat_proxy=False) -> None:
    ...
    def think_and_send(self):
        ...
        if self.state == 1 or (behavior.is_ready("Get_Up") and self.fat_proxy_cmd is None):
